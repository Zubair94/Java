...
/**
 * Created by Zubair on 12/19/2016.
 */
public class Zombie {
	...
	public Zombie(Transform transform) {
		...
		if(animations == null)
		{
			...
			animations.add(new Texture("SARGA1.png"));
			animations.add(new Texture("SARGB1.png"));
			animations.add(new Texture("SARGC1.png"));
			animations.add(new Texture("SARGD1.png"));

			//Zombie attacks Animation
			animations.add(new Texture("SARGE1.png"));
			animations.add(new Texture("SARGF1.png"));
			animations.add(new Texture("SARGG1.png"));

			animations.add(new Texture("SARGH1.png"));

			//Death Animation After Getting Shot
			animations.add(new Texture("SARGI0.png"));
			animations.add(new Texture("SARGJ0.png"));
			animations.add(new Texture("SARGK0.png"));
			animations.add(new Texture("SARGL0.png"));

			animations.add(new Texture("SARGM0.png"));
		}
